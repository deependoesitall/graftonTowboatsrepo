...
const ACTIONS = [
  ...
  },
  {
    href: '/account',
    icon: LogIn,
    title: 'Sign in to your boat',
    blurb: 'Cooks and captains with an account see boat-scoped order history and saved vessel details.',
    cta: 'Sign in',
    primary: false,
  },
  {
    ...
    blurb: 'Install Grafton Order on your phone — stays signed in, one tap from the wheelhouse.',
    cta: 'Install guide',
    primary: false,
  },
] as const;
