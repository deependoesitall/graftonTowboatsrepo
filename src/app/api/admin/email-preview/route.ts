...
const SAMPLE_ORDER: Order = {
  ...
  eta: '2:00 PM',
  items: [
    { id: '1', order_id: 'sample', product_id: 'p1', description: 'Bologna Salad', category: 'Bakery & Deli', pkg_size: 'PER LB', uom: null, unit_price: 6.29, quantity: 2, line_total: 12.58 },
    { id: '2', order_id: 'sample', product_id: 'p2', description: '2% Milk Gallon', category: 'Dairy & Eggs', pkg_size: '1 GAL', uom: null, unit_price: 3.89, quantity: 3, line_total: 11.67 },
    { id: '3', order_id: 'sample', product_id: 'p3', description: 'Lysol Spray Disinfectant 19oz 2-Pk', category: 'Household', pkg_size: '2 CT', uom: null, unit_price: 9.99, quantity: 1, line_total: 9.99 },
  ],
  subtotal: 34.24,
  status: 'new',
...
export async function POST(req: NextRequest) {
  ...
  const html = buildOrderEmailHtml(SAMPLE_ORDER, {
