...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <LUL items={[
        <>Prices shown come from Sinclair&apos;s current catalog and <strong>may change before your order is shopped.</strong> The register total at the time of purchase is what gets billed.</>,
      ...
      <LP>
        ...
        products are excluded from our catalog automatically and will not
        appear as something you can order. If alcohol is written into an order&apos;s
        notes or added as an off-catalog request, that part of the order will
      ...
      <LSub>Use of the catalog</LSub>
      <LP>
        The product catalog is here so vessels can order from it. It is not
